...
# Game Screen Size, backgrounds, banners, guns, target_images, levels, score, etc
WIDTH = 900
HEIGHT = 800
...
# draw gun object and gun's moving
def draw_gun():
...
# go to next level(Bird -> Plate -> UFO)
...
# If I shot the object, the shoot's creen draw the game screen
...
# game over and indicate your final score
def draw_game_over():
